...
Read the accompanying walk-through here: [https://typesense.org/docs/0.19.0/guide/search-ui-components.html](https://typesense.org/docs/0.19.0/guide/search-ui-components.html).
